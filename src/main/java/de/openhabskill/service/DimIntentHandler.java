...
public class DimIntentHandler extends IntentHandler {
    ...
    public DimIntentHandler(OpenHabClient openHabClient, ItemRepository itemDao) {
    ...
    public SpeechletResponse handleIntentInternal(Intent intent) {
        ...
        if (item == null) {
            ...
            item = itemRepository.findByLocationAndItemNameAndItemType(location.getValue(), stemmedItemValue, ItemType.DIMMER);
        }
